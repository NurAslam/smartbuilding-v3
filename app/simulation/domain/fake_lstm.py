# app/simulation/domain/fake_lstm.py
from sklearn.neural_network import MLPRegressor
import numpy as np

class FakeLSTMRegressor:
    """
    Adapter meniru API Keras LSTM (fit/predict) tapi pakai MLPRegressor (sklearn).
    - Input X: (n_samples, 1, n_features) -> di-reshape ke (n_samples, n_features)
    - predict: return array shape (n_samples,)
    """
...
def make_lstm(n_features: int):
    # nama fungsi tetap 'make_lstm' agar pemanggil tidak berubah
